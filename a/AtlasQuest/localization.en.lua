...
-- Options translation
AQShowRight = "Now shows the AtlasQuest Panel on the right side";
AQShowLeft = "Now shows the AtlasQuest Panel on the left side (default)";
AQHelpText = "type /aq or atlasquest [command]\ncommands: show/hide; left/right; autoshow(only Atlas)"
AQAtlasAutoON = "The AtlasQuest panel will now be automaticly displayed when you open atlas (default)"
AQAtlasAutoOFF = "The AtlasQuest panel won't be displayed when you open atlas now"
...
Inst29Quest6_Note = "You get the prequest from Gaxim Rustfizzle "..YELLOW.."(Stonetalon Mountains; 59,67)"..WHITE..".\nThe white card is a random drop. You find the first terminal next to the back entrance before you enter the instance. The 2. is at [3], the 3. at [5] and the 4. is at [8]."
...
Inst29Quest7_Location = "Kernobee (Gnomeregan "..YELLOW.."[]"..WHITE..")"
...
Inst29Quest3_HORDE_Note = "You find Thermaplugg at [6]. He is the last boss in Gnomeregan.\nDuring the fight you have to disable the columns through pushing the button on the side."
