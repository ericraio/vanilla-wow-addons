if (not ace:LoadTranslation("GuildFu")) then
...
GuildFULocals = {
	...
	TOOLTIP_TITLE = "Guildlist",
	TOOLTIP_NOTINGUILD = "Not in guild",
	TOOLTIP_WARNING = "|cffff0000Too many persons, use filtering.|r",
	MENU_FILTER_DUNGEON = "People not in an instance",
	MENU_FILTER_BATTLEGROUND = "People not in battlegrounds",
